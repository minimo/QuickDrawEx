...
tm.define("tmapp.SoundSet", {
    ...
    add: function(name, url) {
        ...
        switch(this.defaultType) {
            case MEDIA_ASSET:
                e = tmapp.SoundElement_WebAudio(name);
                break;
            case MEDIA_CORDOVA:
                e = tmapp.SoundElement_CordovaMedia(name, url);
                break;
            case MEDIA_LLA:
                e = tmapp.SoundElement_LLA(name, url);
                break;
        }
...
tm.define("tmapp.SoundElement_WebAudio", {
    superClass: tmapp.SoundElement,
...
tm.define("tmapp.SoundElement_CordovaMedia", {
    superClass: tmapp.SoundElement,
...
tm.define("tmapp.SoundElement_LLA", {
    superClass: tmapp.SoundElement,
    lla: null,
    init: function(name, url) {
